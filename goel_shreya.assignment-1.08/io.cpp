...
void io_battle(character *aggressor, character *defender)
{
  ...
  io_display();
  clear();
  mvprintw(0, 10, "Here's info about the trainer's pokemon:");
  mvprintw(6, 10, "Name: %s", n->pokemon_team[0]->getName());
  mvprintw(7, 10, "HP: %i", n->pokemon_team[0]->getHP());
  mvprintw(8, 10, "Attack: %i", n->pokemon_team[0]->getAtk());
  mvprintw(9, 10, "Defense: %i", n->pokemon_team[0]->getDef());
  mvprintw(10, 10, "Sp Attack: %i", n->pokemon_team[0]->getSpAtk());
  mvprintw(11, 10, "Sp Defense: %i", n->pokemon_team[0]->getSpDef());
  mvprintw(12, 10, "Speed: %i", n->pokemon_team[0]->getSpd());
  mvprintw(13, 10, "Move 1: %s", n->pokemon_team[0]->getMove1());
  mvprintw(14, 10, "Move 2: %s", n->pokemon_team[0]->getMove2());
  mvprintw(16, 10, "Press any key to proceed");
  refresh();
  getch();
...
void io_starter() {
  ...
  Pokemon *starter_1 = new Pokemon(1);
  Pokemon *starter_2 = new Pokemon(1);
  Pokemon *starter_3 = new Pokemon(1);

  clear();
  mvprintw(0, 10, "You are going to choose a pokemon. Enter 1, 2, or 3: ");
  mvprintw(11, 10, "   1) %s", starter_1->getName());
  mvprintw(12, 10, "   2) %s", starter_2->getName());
  mvprintw(13, 10, "   3) %s", starter_3->getName());
  ...
  do {
    ...
    switch (ch) {
        case '1':
          world.pc.pokemon_team[0] = starter_1;
          delete starter_2;
          delete starter_3;
          chosen = true;
          break;
        case '2':
          world.pc.pokemon_team[0] = starter_2;
          delete starter_1;
          delete starter_3;
          chosen = true;
          break;
        case '3':
          world.pc.pokemon_team[0] = starter_3;
          delete starter_1;
          delete starter_2;
          chosen = true;
          break;
  ...
  mvprintw(0, 10, "Here's some more info about your pokemon:");
  mvprintw(6, 10, "Name: %s", world.pc.pokemon_team[0]->getName());
  mvprintw(7, 10, "HP: %i", world.pc.pokemon_team[0]->getHP());
  mvprintw(8, 10, "Attack: %i", world.pc.pokemon_team[0]->getAtk());
  mvprintw(9, 10, "Defense: %i", world.pc.pokemon_team[0]->getDef());
  mvprintw(10, 10, "Sp Attack: %i", world.pc.pokemon_team[0]->getSpAtk());
  mvprintw(11, 10, "Sp Defense: %i", world.pc.pokemon_team[0]->getSpDef());
  mvprintw(12, 10, "Speed: %i", world.pc.pokemon_team[0]->getSpd());
  mvprintw(13, 10, "Move 1: %s", world.pc.pokemon_team[0]->getMove1());
  mvprintw(14, 10, "Move 2: %s", world.pc.pokemon_team[0]->getMove2());
  mvprintw(16, 10, "Press any key to proceed");
...
void io_encounter_pokemon(){
  ...
  mvprintw(0, 10, "You have encountered a pokemon. Here's the info:");
  mvprintw(4, 10, "Name: %s", pokemon->getName());
  mvprintw(6, 10, "HP: %i", pokemon->getHP());
  mvprintw(7, 10, "Attack: %i", pokemon->getAtk());
  mvprintw(8, 10, "Defense: %i", pokemon->getDef());
  mvprintw(9, 10, "Sp Attack: %i", pokemon->getSpAtk());
  mvprintw(10, 10, "Sp Defense: %i", pokemon->getSpDef());
  mvprintw(11, 10, "Speed: %i", pokemon->getSpd());
  mvprintw(12, 10, "Move 1: %s", pokemon->getMove1());
  mvprintw(13, 10, "Move 2: %s", pokemon->getMove2());
  mvprintw(14, 10, "Press any key to continue with the game");
